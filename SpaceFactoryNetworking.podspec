#
#  Be sure to run `pod spec lint SpaceFactoryNetworking.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  s.source       = { :git => "https://github.com/daltonclaybrook/SpaceFactoryNetworking.git", :branch => "master" }
